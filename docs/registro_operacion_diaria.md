...
|---|---|---|---|---|---|---|---|---|---|
| 2026-03-09 | 18:05 | Gonzalo | OK | N/A | OK | No | Validacion M12 Auto-pick: sin `X-Idempotency-Key` retorna 400 esperado; con key (`autopick-manual-001`) retorna 200 con `execution_status=executed` y `decision=executed_test_order` | Cerrado OK | API: `/ops/execution/pretrade/binance/auto-pick` |
